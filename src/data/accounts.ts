...
export const accountsPool: Account[] = [
  { id: 'echo', name: 'Echo Theory', initials: 'ET', monthly: '2.1M', color: '#e3b53a', img: 'images/artists/echo-theory.webp' },
  { id: 'nova', name: 'Nova Reign', initials: 'NR', monthly: '845K', color: '#5b9fe3', img: 'images/artists/nova-reign.jpg' },
